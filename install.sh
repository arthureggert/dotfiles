...
#BASH-IT
ln -s ~/Documentos/workspace/dotfiles/bash-it/bashrc  ~/.bashrc
ln -s ~/Documentos/workspace/dotfiles/bash-it/bash_profile ~/.bash_profile
...
#GIT
ln -s ~/Documentos/workspace/dotfiles/git/gitconfig ~/.gitconfig
ln -s ~/Documentos/workspace/dotfiles/git/gitignore ~/.gitignore

#BASH-IT
bash-it enable alias atom clipboard curl git maven npm tmux vim
bash-it enable plugin battery dirs extract git java javascript node proxy ssh tmux
bash-it enable completion defaults dirs git gradle grunt gulp jboss7 maven npm ssh tmux
